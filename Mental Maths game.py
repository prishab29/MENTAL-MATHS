import random
print("✋Hello!")
a = input("Choose an operation to practice:\nAddition'1'\nSubtraction'2'\nMultiplication'3'\nDivision'4'\nYour choice(in number): ")
...
try:
    a=int(a)     
            ...
            print ("INVALID INPUT")
b = input("Choose a difficulty level:\nEasy'1'\nMedium'2'\nHard'3'\nYour choice(in number): ")
...
#This is for when the user chooses division and level easy
    ...
    print ("INVALID INPUT, Please start the game again")
c=input("Choose how you wish to continue:\n﻿﻿Do more questions(1)\nEnd the game(2)\nYour choice(in number):")
if c=="":
    print("INVALID INPUT")  # Inform the user of invalid input
try:
    c=int(c)     
except ValueError:
            print ("INVALID INPUT")
